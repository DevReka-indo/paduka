...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('fasilitas-qc/kategori')
        ...
        ->group(function () {
            ...
            Route::get(
                '/',
                [QcFacilityCategoryController::class, 'index']
            )->name('index');

            Route::post(
                '/',
                [QcFacilityCategoryController::class, 'store']
            )->name('store');
    ...
    Route::prefix('fasilitas-qc')
        ...
        ->group(function () {
            ...
            */
            ...
            Route::get(
                '/',
                [QcFacilityController::class, 'index']
            )->name('index');
            ...
            */
            ...
            Route::get(
                '/{qcFacility}/units/{qcFacilityUnit}',
                [QcFacilityUnitController::class, 'show']
            )->name('units.show');

            // Kelola unit hanya admin / superadmin
            Route::middleware('isAdmin')->group(function () {
                ...
                */
                Route::get(
                    '/create',
                    [QcFacilityController::class, 'create']
                )->name('create');

                Route::post(
                    '/',
                    [QcFacilityController::class, 'store']
                )->name('store');

                Route::get(
                    '/{qcFacility}/edit',
                    [QcFacilityController::class, 'edit']
                )->name('edit');

                Route::put(
                    '/{qcFacility}',
                    [QcFacilityController::class, 'update']
                )->name('update');

                Route::delete(
                    '/{qcFacility}',
                    [QcFacilityController::class, 'destroy']
                )->name('destroy');
                ...
                */
                Route::get(
                    '/{qcFacility}/units/create',
                    [QcFacilityUnitController::class, 'create']
                )->name('units.create');

                Route::post(
                    '/{qcFacility}/units',
                    [QcFacilityUnitController::class, 'store']
                )->name('units.store');

                Route::get(
                    '/{qcFacility}/units/{qcFacilityUnit}/edit',
                    [QcFacilityUnitController::class, 'edit']
                )->name('units.edit');

                Route::put(
                    '/{qcFacility}/units/{qcFacilityUnit}',
                    [QcFacilityUnitController::class, 'update']
                )->name('units.update');

                Route::delete(
                    '/{qcFacility}/units/{qcFacilityUnit}',
                    [QcFacilityUnitController::class, 'destroy']
                )->name('units.destroy');
            });

            /*
            * Route detail master harus paling bawah
            * karena /{qcFacility} bersifat dinamis.
            */
            Route::get(
                '/{qcFacility}',
                [QcFacilityController::class, 'show']
            )->name('show');
        });
