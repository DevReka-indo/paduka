    ...
    <div class="py-6 max-w-2xl mx-auto space-y-4">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="flex items-center gap-3 px-6 py-4 border-b border-gray-100">
                ...
                <div>
                    <h3 class="text-sm font-semibold text-gray-800">Edit Temuan — {{ $lokasi->nomor_temuan }}</h3>
                    <p class="text-xs text-gray-400">Perbarui data lokasi temuan</p>
                </div>
            </div>
            ...
            <form method="POST" action="{{ route('temuan.update', $lokasi) }}" class="p-6 space-y-5">
                ...
                <div>
                    ...
                    <x-text-input id="nomor_temuan_preview" type="text"
                        ...
                        readonly />
                    <p class="mt-1 text-xs text-gray-400">Nomor temuan dibuat otomatis oleh sistem dan tidak dapat diubah.</p>
                </div>

                <div>
                    <x-input-label for="status_temuan" value="Lokasi Temuan" />
                    <x-text-input id="status_temuan" name="status_temuan" type="text" class="mt-1 block w-full"
                        :value="old('status_temuan', $lokasi->status_temuan)" required maxlength="25" />
