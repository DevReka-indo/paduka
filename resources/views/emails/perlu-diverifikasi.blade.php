...
<head>
    ...
    <title>NCR Perlu Diverifikasi</title>
</head>
                ...
                <table role="presentation" width="640" cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tr>
                        <td style="padding:0 36px;">
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"
                                style="margin-top:-18px; background:#ffffff; border:1px solid #dbeafe; border-radius:14px;">
                                <tr>
                                    <td style="padding:18px 20px;">
                                        <div style="font-size:12px; font-weight:700; color:#2563eb; text-transform:uppercase; letter-spacing:1px;">
                                            Notifikasi Verifikasi NCR
                                        </div>
                                        <div style="font-size:20px; font-weight:700; color:#0f172a; padding-top:6px;">
                                            NCR telah ditanggapi dan perlu diverifikasi
                                        </div>
                                        <div style="font-size:14px; color:#475569; line-height:1.7; padding-top:8px;">
                                            Mohon lakukan proses verifikasi agar status penanganan NCR dapat ditindaklanjuti sesuai alur yang berlaku.
                                        </div>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td style="padding:32px 36px 16px 36px;">
                            <div style="font-size:15px; color:#334155; line-height:1.8;">
                                Halo <strong>{{ $notifiable->name ?? 'User' }}</strong>,
                            </div>

                            <div style="font-size:15px; color:#334155; line-height:1.8; padding-top:14px;">
                                NCR berikut telah mendapatkan tanggapan dan saat ini memerlukan verifikasi dari Anda.
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:0 36px 8px 36px;">
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"
                                style="background:#ffffff; border:1px solid #dbeafe; border-radius:14px;">
                                <tr>
                                    <td style="padding:22px 24px;">
                                        ...
                                        <div style="padding-top:16px; font-size:14px; color:#475569; line-height:1.7;">
                                            Silakan buka detail NCR untuk melihat tanggapan yang sudah diberikan dan lanjutkan proses verifikasi.
                                        </div>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td style="padding:8px 36px 24px 36px;">
                            <div style="font-size:14px; color:#475569; line-height:1.8;">
                                Silakan lakukan verifikasi pada NCR tersebut agar proses penyelesaian dapat segera diproses lebih lanjut.
                            </div>
