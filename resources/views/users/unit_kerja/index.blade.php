    ...
    <div class="py-6 max-w-7xl mx-auto space-y-4">
        ...
        <div class="flex items-center justify-between">
            <p class="text-sm text-gray-400 dark:text-gray-500">Kelola daftar unit kerja untuk pengguna</p>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-4">
            <form method="GET" action="{{ route('unit-kerja.index') }}" class="flex flex-wrap gap-3 items-end">
                <div class="flex-1 min-w-48">
                    ...
                    <div class="relative">
                        <svg class="w-4 h-4 text-gray-400 absolute left-3 top-1/2 -translate-y-1/2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="w-40">
                    ...
                    <select name="status"
                        class="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 rounded-lg focus:ring-indigo-500 dark:focus:ring-indigo-400">
                ...
                <div class="flex gap-2">
                    ...
                    @if(request('search') || request('status'))
                        <a href="{{ route('unit-kerja.index') }}"
                            class="px-4 py-2 bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 text-sm font-medium rounded-lg transition-colors">
                            Reset
                        </a>
                    @endif
                </div>
                ...
                <table class="w-full text-sm">
                    <thead>
                        <tr class="bg-gray-50 dark:bg-gray-900 border-b border-gray-100 dark:border-gray-700 text-xs uppercase tracking-wide text-gray-400 dark:text-gray-500">
                            ...
                            <th class="px-4 py-3 text-left">Nama Unit Kerja</th>
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                        @forelse($unitKerja as $item)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                ...
                                <td class="px-4 py-3 text-gray-500 dark:text-gray-400 max-w-[220px]">
                            ...
                            <tr>
                                <td colspan="7" class="px-4 py-12 text-center">
                                    <div class="flex flex-col items-center gap-2 text-gray-300 dark:text-gray-600">
                                        ...
                                        <p class="text-sm font-medium text-gray-400 dark:text-gray-500">Belum ada data unit kerja</p>
                                        <a href="{{ route('unit-kerja.create') }}" class="text-xs text-indigo-500 hover:underline">
