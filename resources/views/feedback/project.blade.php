    ...
    <div class="mx-auto max-w-[1400px] space-y-6">
        ...
        <div class="rounded-3xl border border-gray-100 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
            <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                ...
                <a href="{{ route('feedback-projects.create') }}"
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
            <div class="rounded-3xl border border-indigo-100 bg-indigo-50 p-5 shadow-sm dark:border-indigo-900/30 dark:bg-indigo-900/20">
                ...
                <p class="mt-3 text-4xl font-bold text-indigo-700 dark:text-indigo-300">
                    {{ number_format($feedbackProjects->total()) }}
                </p>
            </div>

            <div class="rounded-3xl border border-gray-100 bg-white p-5 shadow-sm dark:border-gray-800 dark:bg-gray-900 md:col-span-2">
                <form method="GET" action="{{ route('feedback.project') }}" class="flex flex-col gap-3 md:flex-row">
                    <input
                        type="text"
                        name="project_search"
                        value="{{ $projectSearch }}"
                ...
                <table class="w-full text-sm">
                    <thead class="bg-gray-50 text-xs uppercase tracking-wide text-gray-500 dark:bg-gray-800/70 dark:text-gray-400">
                        <tr>
                            ...
                            <th class="px-5 py-4 text-left font-bold">Nama Project</th>
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                        @forelse($feedbackProjects as $index => $project)
                            <tr class="transition hover:bg-gray-50 dark:hover:bg-gray-800/50">
                                ...
                                <td class="max-w-[360px] truncate px-5 py-4 text-gray-600 dark:text-gray-300" title="{{ $project->deskripsi }}">
                                    {{ $project->deskripsi ?: '—' }}
                                </td>
                                ...
                                <td class="px-5 py-4">
                                    <div class="flex justify-end gap-2">
                                        <a href="{{ route('feedback-projects.edit', $project->id) }}"
                                ...
                                <td colspan="5" class="px-5 py-16 text-center">
                                    <div class="flex flex-col items-center gap-3">
                                        ...
                                        <p class="font-semibold text-gray-500 dark:text-gray-400">
                                            Belum ada master project feedback
                                        </p>
                                        <p class="text-sm text-gray-400 dark:text-gray-500">
                                            Klik Tambah Project untuk membuat pilihan dropdown survey.
                                        </p>
                                    </div>
                                </td>
                            </tr>
