...
<div class="fb-wrapper">
    <div class="fb-header">
        <div>
            <h1 class="fb-title">Tambah Barang Project</h1>
            <p class="fb-subtitle">Tambahkan barang atau komponen yang terkait dengan project feedback.</p>
        </div>
    ...
    <div class="fb-card">
        <div class="fb-card-header">
            ...
            <div class="fb-card-subtitle">Pilih project, lalu lengkapi nama barang dan status aktifnya.</div>
        </div>

        <form action="{{ route('feedback-project-items.store') }}" method="POST" class="fb-form">
            @csrf
            ...
            <div class="fb-field">
                ...
                <textarea id="deskripsi"
                          ...
                          rows="4"
                          placeholder="Tambahkan deskripsi singkat barang">{{ old('deskripsi') }}</textarea>
