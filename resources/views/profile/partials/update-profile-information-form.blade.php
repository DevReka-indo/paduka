    ...
    <form method="post" action="{{ route('profile.update') }}" enctype="multipart/form-data"
        ...
        <div class="flex items-center gap-5 pb-6 border-b border-gray-100">
            ...
            <div>
                ...
                <p class="text-xs text-gray-400 mt-0.5">Klik foto untuk mengganti. Format: jpg, png, webp. Maks 2MB.</p>
                <span class="inline-block mt-2 text-xs bg-gray-100 text-gray-500 px-2.5 py-1 rounded-full">
                    {{ $user->level ?? 'User' }}
                </span>
                <p x-show="hasFile" x-transition class="mt-1.5 text-xs text-indigo-500 font-medium">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div class="md:col-span-2">
                ...
                <x-text-input id="level" type="text"
                    class="mt-1 block w-full bg-gray-50 text-gray-400 cursor-not-allowed"
                    :value="old('level', $user->level)" readonly />
                <p class="mt-1 text-xs text-gray-400">Level akun hanya dapat diubah oleh admin.</p>
            </div>

        </div>

        {{-- Unit Kerja — tampil saja, tidak bisa diubah sendiri --}}
        <div class="pt-4 border-t border-gray-100">
            <x-input-label :value="__('Unit Kerja')" />
            <p class="text-xs text-gray-400 mt-0.5 mb-3">Unit kerja hanya dapat diubah oleh admin.</p>
