...
<div class="py-6 max-w-2xl mx-auto space-y-4">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
        <div class="flex items-center gap-3 px-6 py-4 border-b border-gray-100 dark:border-gray-700">
            ...
            <div>
                <h3 class="text-sm font-semibold text-gray-800 dark:text-gray-100">Form Tambah Project</h3>
                <p class="text-xs text-gray-400 dark:text-gray-500">Isi data project baru</p>
            </div>
        </div>
        ...
        <form method="POST" action="{{ route('projects.store') }}" class="p-6 space-y-5">
            ...
            <div>
                ...
                <x-text-input id="nomor_proyek_preview" type="text"
                    ...
                    :value="$nomorPreview"
                    readonly />
                <p class="mt-1 text-xs text-gray-400 dark:text-gray-500">Nomor proyek akan dibuat otomatis saat disimpan.</p>
            </div>
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-gray-400 dark:text-gray-500">Maksimal 50 karakter, harus unik. Digunakan sebagai referensi di NCR.</p>
            </div>
