...
<div class="py-6 max-w-7xl mx-auto space-y-4">
    ...
    <div class="flex items-center justify-between">
        <p class="text-sm text-gray-400">Daftar NCR yang perlu diverifikasi</p>
    </div>
                ...
                <tbody class="divide-y divide-gray-50">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-4 py-3">
                            ...
                            @else
                                <span class="inline-flex items-center gap-1 text-xs font-semibold bg-gray-100 text-gray-400 px-2.5 py-1 rounded-full">
                            ...
                            <div class="flex items-center gap-1.5">
                                ...
                                @if((int) auth()->id() === (int) $item->user_id)
                                    <a href="{{ route('ncr.verifikasi.form', $item->nomor_ncr) }}"
                                        class="inline-flex items-center gap-1 text-xs font-medium bg-emerald-50 text-emerald-600 hover:bg-emerald-100 px-2.5 py-1.5 rounded-lg transition-colors">
                                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                                        </svg>
                                        Verifikasi
