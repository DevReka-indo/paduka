        ...
        <form action="{{ route('ncr.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="flex items-center gap-3 px-6 py-4 border-b border-gray-100">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-400">Nomor NCR, tanggal, dan inspektor</p>
                    </div>
                </div>
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <x-text-input id="nomor_ncr" name="nomor_ncr" type="text"
                            class="mt-1 block w-full bg-gray-50 text-gray-500 cursor-not-allowed" :value="old('nomor_ncr', $nomorNCR)"
                            readonly />
                    </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    {{-- Unit Kerja dropdown (unit_kerja_id) --}}
                    <div class="md:col-span-2">
            ...
            {{-- up_file disimpan via store('ncr', 'public') → tampil dengan Storage::url() --}}
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                new TomSelect(el, {
                    ...
                    render: {
                        no_results: function(data, escape) {
                            return '<div class="no-results p-3 text-sm text-gray-400">Tidak ada hasil untuk "' + escape(data.input) + '"</div>';
                        }
                    },
